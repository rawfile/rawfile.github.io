...
#Banner{
    background-image:url(../images/DocBanner.png);
...
#MyAccountBalanceContainer .Earnings_LoginAward,#MyAccountBalanceContainer .Earnings_PlaceTrafficAward,#MyAccountBalanceContainer .Earnings_SaleOfGoods,#MyAccountBalanceContainer .Earnings_Ambassador,#MyAccountBalanceContainer .Earnings_PeriodTotal{
    padding:0 0 0 80px;
}
...
.CurrencyQuote,.CurrencyTrade,.CurrencyOffers,.CurrencyBids,.TradingDashboard{
    width:350px;
}
.CurrencyQuote,.CurrencyTrade,.CurrencyOffers,.CurrencyBids,.OpenBids,.OpenOffers,.TradeHistory{
    background-color:#fff;
    border:solid 1px #000;
    padding:0;
}
.CurrencyQuote,.CurrencyTrade,.TradingDashboard,.OpenBids,.OpenOffers,.TradeHistory,.TradingDashboard .FooterPager{
    margin:0 auto;
}
.CurrencyTrade,.TradingDashboard{
    margin-top:20px;
}
.CurrencyTradeDetails{
    padding:5px;
}
.CurrencyTradeDetail,.TradingDashboard .FooterPager{
    padding-top:5px;
    text-align:center;
}
...
#EditItemContainer #Comments,#EditItemContainer #PlaceAccess,#EditItemContainer #PlaceCopyProtection,#EditItemContainer #AllowGear,#EditItemContainer #VersionHistory,#EditItemContainer #PublicDomain,#EditItemContainer #SellThisItem,#EditItemContainer #PlaceReset,.MyItemOptions{
    margin:0 auto;
    margin-top:10px;
    width:420px;
}
...
.AgeOptions #Under13,.AgeOptions #Over12{
    float:left;
    margin:0;
    padding:0 20px;
    width:200px;
...
#ConfigurePlaceContainer #PlaceAccess,#ConfigurePlaceContainer #PlaceCopyProtection,#ConfigurePlaceContainer #Comments,#ConfigurePlaceContainer #PlaceIsDefault,#ConfigurePlaceContainer #PlaceReset,#ConfigurePlaceContainer #AllowGear{
    margin:0 auto;
    margin-top:10px;
    width:420px;
}
#ConfigurePlaceContainer .PlaceAccessRow,#ConfigurePlaceContainer .CopyProtectionRow,#ConfigurePlaceContainer .EnableCommentsRow,#ConfigurePlaceContainer .PlaceIsDefaultRow,.MyItemIndentedOption{
    font-size:.9em;
    margin:10px 0 10px 100px;
}
...
#EditProfileContainer #AgeGroup,#EditProfileContainer #ChatMode,#EditProfileContainer #PrivacyMode,#EditProfileContainer #ResetPassword,#EditProfileContainer #Blurb{
    margin:0 auto;
    width:60%;
}
...
#SplashContainer #RobloxAtAGlance #ThingsToDo #Point2{
    background-image:url(../images/FriendsIcon.png);
}
#SplashContainer #RobloxAtAGlance #ThingsToDo #Point3{
    background-image:url(../images/BattleIcon.png);
}
...
#MembershipOptions #OneMonth,#MembershipOptions #SixMonths,#MembershipOptions #TwelveMonths,#SpecialMembershipOption #Lifetime{
    float:left;
    margin:0;
    padding:0 20px;
    width:214px;
}
#MembershipOptions .Label,#SpecialMembershipOption .Label{
    text-align:center;
}
#WhyJoin{
    display:inline;
